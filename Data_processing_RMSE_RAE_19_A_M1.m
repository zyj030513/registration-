...
for mm = Chouqv_all:-1:1
    ...
    for tt = 1:Simulation_times
        ...
        Error_beta_19_S4_range(tt) = beta_19(tt,12) - RadarPar(1,4).range_bias;
    end
    ...
    RMSE_beta_19_S4_range(Chouqv_all + 1 - mm) = sqrt(mse(Error_beta_19_S4_range))
    
end

figure
plot(Error_beta_19_S1_theta,'k')
title('S1 theta')

figure
plot(Error_beta_19_S1_phi,'k')
title('S1 phi')


figure
plot(Error_beta_19_S1_range,'k')
title('S1 range')


figure
plot(Error_beta_19_S2_theta,'k')
title('S2 theta')

figure
plot(Error_beta_19_S2_phi,'k')
title('S2 phi')

figure
plot(Error_beta_19_S2_range,'k')
title('S2 range')


figure
plot(Error_beta_19_S3_theta,'k')
title('S3 theta')

figure
plot(Error_beta_19_S3_phi,'k')
title('S3 phi')

figure
plot(Error_beta_19_S3_range,'k')
title('S3 range')


figure
plot(Error_beta_19_S4_theta,'k')
title('S4 theta')

figure
plot(Error_beta_19_S4_phi,'k')
title('S4 phi')


figure
plot(Error_beta_19_S4_range,'k')
title('S4 range')
